...
System.register("https://unpkg.com/@vanillawc/wc-codemirror@1.9.1/index", [], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            ...
            NativeScrollbars = class NativeScrollbars {
            ...
            NullScrollbars = class NullScrollbars {
                update() {
            ...
            SharedTextMarker = class SharedTextMarker {
...
System.register("file:///home/awesomewaterapple/contributions/wc-code/src/console", [], function (exports_2, context_2) {
    ...
    return {
        setters: [],
        execute: function () {
            WCCodeConsole = class WCCodeConsole {
                constructor(wccode) {
                    this.elements = {};
        ...
        execute: function () {
            WCCodeZone = class WCCodeZone extends HTMLElement {
                constructor() {
                    ...
                    this.zone = new zone_js_1.default();
...
System.register("file:///home/awesomewaterapple/contributions/wc-code/src/utils", ["file:///home/awesomewaterapple/contributions/wc-code/src/wc-code-zone"], function (exports_7, context_7) {
    ...
    function findParentWCCodeZone(wccode) {
        ...
        while (true) {
            ...
            else if (parent instanceof wc_code_zone_js_1.default) {
                return parent;
            }
            else if (!parent) {
                return null;
    ...
    return {
        setters: [
            function (wc_code_zone_js_1_1) {
                wc_code_zone_js_1 = wc_code_zone_js_1_1;
            }
        ],
        execute: function () {
            addedScripts = {};
...
System.register("file:///home/awesomewaterapple/contributions/wc-code/src/wc-code", ["https://unpkg.com/@vanillawc/wc-codemirror@1.9.1/index", "file:///home/awesomewaterapple/contributions/wc-code/src/console", "file:///home/awesomewaterapple/contributions/wc-code/src/language-details", "file:///home/awesomewaterapple/contributions/wc-code/src/utils", "file:///home/awesomewaterapple/contributions/wc-code/src/zone", "file:///home/awesomewaterapple/contributions/wc-code/src/main"], function (exports_8, context_8) {
    ...
    return {
        setters: [
            ...
            function (language_details_js_1_1) {
                language_details_js_1 = language_details_js_1_1;
            },
            function (Utils_1) {
                Utils = Utils_1;
            },
            function (zone_js_2_1) {
                zone_js_2 = zone_js_2_1;
            },
        ...
        execute: function () {
            ...
            main_js_2.default.WCCode = class extends index_js_1.WCCodeMirror {
                constructor() {
                    ...
                    if (inWCZone) {
                        ...
                        if (this.parentZoneElement.hasAttribute('theme')) {
                            this.setAttribute('theme', this.parentZoneElement.getAttribute('theme'));
                        }
                    }
                    else {
                        this.zone = new zone_js_2.default();
                    }
                    this.addLoadingBar();
                    this.addButtons();
                    this.addConsole();
                ...
                get languageOptions() {
                    return main_js_2.default.languages[this.language];
                }
                ...
                checkLanguageExists() {
                    ...
                    const languageStuff = language_details_js_1.default.languages[language];
                    if (languageStuff)
                        return;
                ...
                async initLanguageFiles() {
                    ...
                    await Utils.importScriptIfRequired(languageStuff.CMLanguageLoc, language_details_js_1.default.metaUrl);
                    this.loadingBar.setText('loading wc-code language file...');
                    await Utils.importScriptIfRequired(languageStuff.languageFile, language_details_js_1.default.metaUrl);
                    if (this.languageOptions.additionalScripts) {
                        this.loadingBar.setText('loading additional required scripts...');
                        await Utils
                            .addScriptsIfRequired(this.languageOptions.additionalScripts, this.languageOptions.meta.url);
                    }
                }
                async initLanguage() {
            ...
            customElements.define('wc-code', main_js_2.default.WCCode);
        }
    };
});

__instantiate("file:///home/awesomewaterapple/contributions/wc-code/src/wc-code", false);
